...
for i in range(16):
    if i%4 == 0:
        ...
        s = output[i//4][1]
        norm = {'type' : s}
        f, b, l_d = run_exp_anorexia(i+65, tr_anorexia, test_anxia, tr_label, test_labels_anxia, chose =3,tau=0.95, remove_stop=k,
...
df.to_csv('/home/est_posgrado_maria.garcia/Proyecto_tecnologico/Results/Anorexia_fuzzy/result_fuzzy_anxia5.csv',sep='\t')
...
#    f.write(dfAsString)
#    f.close()
df.to_csv('/home/est_posgrado_maria.garcia/Proyecto_tecnologico/Results/Anorexia_fuzzy/Best_Result_fuzzy_anxia5.csv',sep='\t')
