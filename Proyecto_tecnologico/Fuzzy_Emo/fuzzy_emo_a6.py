...
for i in range(16):
    if i%4 == 0:
        ...
        s = output[i//4][1]
        norm = {'type' : s}
        f, b, l_d = run_exp_anorexia(i+81, tr_anorexia, test_anxia, tr_label, test_labels_anxia, chose = 4,tau=0.8, remove_stop=k,
...
df.to_csv('/home/est_posgrado_maria.garcia/Proyecto_tecnologico/Results/Anorexia_fuzzy_emo/result_fuzzy_anxia6.csv',sep='\t')
