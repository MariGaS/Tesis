...
for i in range(12):
    f,a, l1, l2 = run_exp_anxia_sim(i+145, all_pos, all_neg,test_anxia,test_labels_anxia, tr_label,arg1[i],arg2[i],tau=arg3[i],
...
for i in range(12):
    f,a, l1, l2 = run_exp_anxia_sim(i+157, all_pos, all_neg,test_anxia,test_labels_anxia, tr_label,arg1[i],arg2[i],tau=arg3[i],
...
#en este si importa 
for i in range(12):
    f,a, l1, l2 = run_exp_anxia_sim(i+169, all_pos, all_neg,test_anxia,test_labels_anxia, tr_label,arg1[i],arg2[i],tau=arg3[i],
    ...
    len2.append(l2)
for i in range(12):
    f,a, l1,l2 = run_exp_anxia_sim(i+181, all_pos, all_neg,test_anxia,test_labels_anxia, tr_label,arg1[i],arg2[i],tau=arg3[i],
...
data = { 'score1':score1, 'score2':score2,  'tol': tol, 'remove_stop':rem,'fuzzy':vec,'no_dist': n_d, 
            ...
            'concatenate': con, 'word_embedding': cho }
df = pd.DataFrame(data, index= l)


df.to_csv('/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/Results/Anorexia_fuzzy_key/result_fuzzy_key_anxia4.csv',sep='\t')
