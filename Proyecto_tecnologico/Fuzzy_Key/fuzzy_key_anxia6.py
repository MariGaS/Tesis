...
for i in range(12):
    f,a = run_exp_anxia_sim(i+241, all_pos, all_neg,test_anxia,test_labels_anxia, tr_label,arg1[i],arg2[i],tau=arg3[i],
...
for i in range(12):
    f,a = run_exp_anxia_sim(i+253, all_pos, all_neg,test_anxia,test_labels_anxia, tr_label,arg1[i],arg2[i],tau=arg3[i],
                            chose =1,dif = m[i], fuzzy= arg5[i],remove_stop=arg7[i],train_data = True, compress=False, concatenate = False)
    f_score.append(f)
    best.append(a)
#en este si importa 
for i in range(12):
    f,a = run_exp_anxia_sim(i+265, all_pos, all_neg,test_anxia,test_labels_anxia, tr_label,arg1[i],arg2[i],tau=arg3[i],
...
for i in range(12):
    f,a = run_exp_anxia_sim(i+277, all_pos, all_neg,test_anxia,test_labels_anxia, tr_label,arg1[i],arg2[i],tau=arg3[i],
...
df.to_csv('/home/est_posgrado_maria.garcia/Proyecto_tecnologico/Results/Anorexia_fuzzy_key/result_fuzzy_key_anxia6.csv',sep='\t')
