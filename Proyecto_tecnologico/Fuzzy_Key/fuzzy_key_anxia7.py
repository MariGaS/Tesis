...
for i in range(12):
    f,a, l1, l2 = run_exp_anxia_sim(i+1001, all_pos, all_neg,test_anxia,test_labels_anxia, tr_label,arg1[i],arg2[i],tau=arg3[i],
...
for i in range(12):
    f,a,l1,l2 = run_exp_anxia_sim(i+1013, all_pos, all_neg,test_anxia,test_labels_anxia, tr_label,arg1[i],arg2[i],tau=arg3[i],
...
#en este si importa 
for i in range(12):
    f,a,l1,l2 = run_exp_anxia_sim(i+1025, all_pos, all_neg,test_anxia,test_labels_anxia, tr_label,arg1[i],arg2[i],tau=arg3[i],
...
for i in range(12):
    f,a,l1,l2 = run_exp_anxia_sim(i+1037, all_pos, all_neg,test_anxia,test_labels_anxia, tr_label,arg1[i],arg2[i],tau=arg3[i],
...
df.to_csv('/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/Results/Anorexia_fuzzy_key/result_fuzzy_key_anxia7.csv',sep='\t')
