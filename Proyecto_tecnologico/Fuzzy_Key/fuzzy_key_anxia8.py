...
for i in range(12):
    f,a, l1, l2 = run_exp_anxia_sim(i+1049, all_pos, all_neg,test_anxia,test_labels_anxia, tr_label,arg1[i],arg2[i],tau=arg3[i],
...
for i in range(12):
    f,a,l1,l2 = run_exp_anxia_sim(i+1061, all_pos, all_neg,test_anxia,test_labels_anxia, tr_label,arg1[i],arg2[i],tau=arg3[i],
...
#en este si importa 
for i in range(12):
    f,a, l1,l2 = run_exp_anxia_sim(i+1073, all_pos, all_neg,test_anxia,test_labels_anxia, tr_label,arg1[i],arg2[i],tau=arg3[i],
    ...
    len2.append(l2)
for i in range(12):
    f,a, l1, l2 = run_exp_anxia_sim(i+1085, all_pos, all_neg,test_anxia,test_labels_anxia, tr_label,arg1[i],arg2[i],tau=arg3[i],
...
data = { 'score1':score1, 'score2':score2,  'tol': tol, 'remove_stop':rem,'fuzzy':vec,'no_dist': n_d,
        'svm':svm, 'compress':compress, 'best':best,'f1': f_score,'words_pos': len1, 'words_neg': len2,
            'concatenate': con, 'word_emebdding': cho}
df = pd.DataFrame(data, index= l)


df.to_csv('/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/Results/Anorexia_fuzzy_key/result_fuzzy_key_anxia8.csv',sep='\t')
