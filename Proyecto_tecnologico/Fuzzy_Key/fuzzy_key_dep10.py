...
arg1 = [x for x in range(1001,1007)]
arg2 = [train_pos, train_pos, train_pos, train_pos, train_pos, train_pos]
arg3 = [train_neg, train_neg, train_neg, train_neg, train_neg, train_neg]
arg4 = [test, test, test, test, test, test]
arg5 = [test_labels, test_labels, test_labels, test_labels, test_labels, test_labels]
arg6 = [train_y,  train_y, train_y, train_y, train_y, train_y]
arg7 = [0.0003,0.0003,0.0003,0.0001,0.0001,0.0001 ] #score1 
arg8 = [0.0003,0.0007,0.0001,0.0001,0.0005,0.00005] #score2
arg9 = [0.99]*6 #tolerancia
arg10 = [3]*6 #chose
arg11 = [False]*6 #fuzzy
arg12 = [False,False,False,False,False,False] #remove stop
arg13 = [True]*6 #train_data 
arg14 = [False]*6#compress
arg15 = [True]*6 #concatenate
arg16 = [False]*6 #dif
