...
data = { 'score1': arg7, 'score2': arg8, 'tol': arg9, 'fuzzy':arg11,'remove_stop' : arg12,
            ...
            'words_pos': l1, 'words_neg': l2, 'concatenate': arg15, 'words_emebeddings': arg10}
df = pd.DataFrame(data, index= arg1)        
print('End experiments')

df.to_csv('/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/Results/Depresion_fuzzy_key/All_result_dep5.csv', sep='\t')
