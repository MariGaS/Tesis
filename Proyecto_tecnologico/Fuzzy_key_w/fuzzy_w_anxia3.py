...
for i in range(12):
    f,a = run_exp_anxia_sim(i+97, all_pos, all_neg,test_anxia,test_labels_anxia, tr_label,arg1[i],arg2[i],tau=arg3[i],w = arg8[i],
                            chose =1,dif = m[i], fuzzy= arg5[i],remove_stop=arg6[i],train_data = True, compress=True, concatenate = True)
    f_score.append(f)
    best.append(a)
    
for i in range(12):
    f,a = run_exp_anxia_sim(i+109, all_pos, all_neg,test_anxia,test_labels_anxia, tr_label,arg1[i],arg2[i],tau=arg3[i],w = arg8[i],
                            chose =1,dif = m[i], fuzzy= arg5[i],remove_stop=arg7[i],train_data = True, compress=True, concatenate = True)
    f_score.append(f)
    best.append(a)
#en este si importa 
for i in range(12):
    f,a = run_exp_anxia_sim(i+121, all_pos, all_neg,test_anxia,test_labels_anxia, tr_label,arg1[i],arg2[i],tau=arg3[i],w = arg8[i],
...
for i in range(12):
    f,a = run_exp_anxia_sim(i+133, all_pos, all_neg,test_anxia,test_labels_anxia, tr_label,arg1[i],arg2[i],tau=arg3[i], w = arg8[i],
...
df.to_csv('/home/est_posgrado_maria.garcia/Proyecto_tecnologico/Results/Anorexia_w_key/Result_w_anxia3.csv',sep='\t')
