...
for i in range(12):
    f,a,len1,len2 = run_exp_anxia_sim(i+145, all_pos, all_neg,test_anxia,test_labels_anxia, tr_label,arg1[i],arg2[i],tau=arg3[i], w = arg8[i],
                            chose =1,dif = m[i], fuzzy= arg5[i],remove_stop=arg6[i],train_data = True, compress=True, concatenate = False)
    f_score.append(f)
    best.append(a)
...
for i in range(12):
    f,a,len1,len2 = run_exp_anxia_sim(i+157, all_pos, all_neg,test_anxia,test_labels_anxia, tr_label,arg1[i],arg2[i],tau=arg3[i],w = arg8[i],
                            chose =1,dif = m[i], fuzzy= arg5[i],remove_stop=arg7[i],train_data = True, compress=True, concatenate = False)
    f_score.append(f)
    best.append(a)
    dic1_len.append(len1)
    dic2_len.append(len2)
#en este si importa 
for i in range(12):
    f,a,len1,len2 = run_exp_anxia_sim(i+169, all_pos, all_neg,test_anxia,test_labels_anxia, tr_label,arg1[i],arg2[i],tau=arg3[i],w = arg8[i],
                            chose =1,dif = n[i], fuzzy= arg5[i],remove_stop=arg6[i],train_data = True, compress=True, concatenate = False)
    f_score.append(f)
    best.append(a)
    dic1_len.append(len1)
    dic2_len.append(len2)
for i in range(12):
    f,a,len1,len2 = run_exp_anxia_sim(i+181, all_pos, all_neg,test_anxia,test_labels_anxia, tr_label,arg1[i],arg2[i],tau=arg3[i],w = arg8[i],
                            chose =1,dif = n[i], fuzzy= arg5[i],remove_stop=arg7[i],train_data = True, compress=True, concatenate = False)
    f_score.append(f)
    best.append(a)
    dic1_len.append(len1)
    dic2_len.append(len2)
...
con = [False]* 48
cho = [1]*48
l = [str(x) for x in range(145,193)]
...
df.to_csv('/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/Results/Anorexia_w_key/Result_w_anxia4.csv',sep='\t')
