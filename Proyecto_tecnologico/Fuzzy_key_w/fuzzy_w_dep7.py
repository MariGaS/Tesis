...
data = { 'score1': arg7, 'score2': arg8, 'tol': arg9, 'fuzzy':arg11,'remove_stop' : arg12,
            'svm':arg13,'compress':arg14, 'n_dif': arg16,'best': a,'f1': f1, 'word_pos':len1, 'words_neg':len2,
            'concatenate': arg15, 'word_embeddings': arg10}
df = pd.DataFrame(data, index= arg1)        
print('End experiments')

df.to_csv('/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/Results/Depresion_w_key/Result_dep7.csv', sep='\t')
