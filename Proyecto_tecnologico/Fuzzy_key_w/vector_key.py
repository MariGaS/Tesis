...
def run_exp_anxia_sim(num_exp, pos_data, neg_data, test_data, test_labels, train_labels, score1, score2,
    ...
    # to capture warnings
    #logging.basicConfig(
    #    filename="/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/Fuzzy_key_w/warnings_anxia.txt", level=logging.DEBUG)
    #logging.info(str(num_exp))
    #logging.captureWarnings(True)
    logging.basicConfig(filename='/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/Fuzzy_key_w/warnings_anxia.txt',level=logging.DEBUG)
    logging.debug('This is a message from experimet number ' + str(num_exp))
    logging.info('This is a message for info')
    logging.captureWarnings(True)
    logging.warning('Warning message for experiment number ' + str(num_exp))
    ...
    if train_data == False:
        ...
        path_name = '/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/Results/Anorexia_w_key' + '/' + result_name
        ...
        with open(path_name, "w") as f:
            ...
            f.close()
        path_name_dic1 = '/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/Results/Anorexia_w_key/dic1' + \
            '/dictionary1_' + str(num_exp) + '.txt'
        path_name_dic2 = '/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/Results/Anorexia_w_key/dic2' + \
            '/dictionary2_' + str(num_exp) + '.txt'
    ...
    if train_data == True:
        ...
        f = open('/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/Fuzzy_key_w/f1_anorexia.txt','a')
        f.write('\n' + str(num_exp) + ',' + str(seed_value) + ',' + str(f1_score(test_labels, y_pred)) + ',' + str(a)) 
        f.close()
        ...
        f = open('/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/Fuzzy_key_w/f1_anorexia.txt','a')
        f.write('\n' + str(num_exp) + ',' + str(seed_value) + ',' + str(f1_score(test_labels, y_pred)) + ',' + str(a)
                                    + ','  + str(np.var([f1,f2,f3,f4,f5])) + ',' + str(np.std([f1,f2,f3,f4,f5]))) 
        f.close()
        ...
        #path_name_dic1 = '/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/Results/Anorexia_w_key/dic1' + '/dictionary1_' + str(num_exp) + '.txt'
        #path_name_dic2 = '/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/Results/Anorexia_w_key/dic2' + '/dictionary2_' + str(num_exp) + '.txt'
...
def run_exp_dep_sim(num_exp, pos_data, neg_data, test_data, test_labels, train_labels, score1, score2,
    ...
    print(num_exp)
    #logging.basicConfig(
    #    filename="/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/Fuzzy_key_w/warnings_dep.txt", level=logging.DEBUG)
    #logging.info(str(num_exp))
    #logging.captureWarnings(True)

    logging.basicConfig(filename='/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/Fuzzy_key_w/warnings_dep.txt',level=logging.DEBUG)
    logging.debug('This is a message from experimet number ' + str(num_exp))
    logging.info('This is a message for info')
    logging.captureWarnings(True)
    logging.warning('Warning message for experiment number ' + str(num_exp))
    ...
    if train_data == False:
        ...
        path_name = '/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/Results/Depresion_w_key' + '/' + result_name
        ...
        with open(path_name, "w") as f:
            ...
            f.close()
        path_name_dic1 = '/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/Results/Depresion_w_key/dic1' + \
            '/dictionary1_' + str(num_exp) + '.txt'
        path_name_dic2 = '/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/Results/Depresion_w_key/dic2' + \
            '/dictionary2_' + str(num_exp) + '.txt'
        ...
        f = open('/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/Fuzzy_key_w/f1_dep.txt','a')
        f.write('\n' + str(num_exp) + ',' + str(seed_value) + ',' + str(f1_score(test_labels, y_pred)) + ',' + str(a)) 
        f.close()
        ...
        f.write('\n' + str(num_exp) + ',' + str(seed_value) + ',' + str(f1_score(test_labels, y_pred)) + ',' + 
                        str(a) + ',' + str(np.var([f1,f2,f3,f4,f5])) + ',' + str(np.std([f1,f2,f3,f4,f5]))) 
        f.close()

        #l = [str(x) for x in range(1,6)]
        #data = { 'seed value':seed_list, 'best_parameter':best_param,  'F1-score': f1_list}
        #df = pd.DataFrame(data, index= l)
        #df.to_csv('/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/Fuzzy_key_w/F1-scores/dep_scores' + str(num_exp)+ '.csv',sep='\t')
        ...
        #    f.close()
        #path_name_dic1 = '/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/Results/Depresion_w_key/dic1' + '/dictionary1_' + str(num_exp) + '.txt'
        #path_name_dic2 = '/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/Results/Depresion_w_key/dic2' + '/dictionary2_' + str(num_exp) + '.txt'
