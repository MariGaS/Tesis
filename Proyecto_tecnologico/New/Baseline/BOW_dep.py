...
for i in range(12):
    ...
    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i+12*23, 2, 2, num_features[i], 'tf_idf', 'NB')
    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i+12*24, 2, 2, num_features[i], 'binary', 'NB')

    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i+12*25, 3, 3, num_features[i], 'tf_stop', 'NB')
    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i + 12*26, 3, 3, num_features[i], 'tf', 'NB')
    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i + 12*27, 3, 3, num_features[i], 'stopwords', 'NB')
    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i + 12* 28, 3, 3, num_features[i], 'tf_idf', 'NB')
    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i + 12*29, 3, 3, num_features[i], 'binary', 'NB')
