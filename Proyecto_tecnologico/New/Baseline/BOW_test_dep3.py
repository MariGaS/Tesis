...
t0 = time()
for i in range(12):
    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i, 1, 1, num_features[i], 'tf_stop', 'svm')
    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i+12, 1, 1, num_features[i], 'tf', 'svm')
    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i+24, 1, 1, num_features[i], 'stopwords', 'svm')
    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i+12*3, 1, 1, num_features[i], 'tf_idf', 'svm')
    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i+12*4, 1, 1, num_features[i], 'binary', 'svm')

    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i+12*5, 2, 2, num_features[i], 'tf_stop', 'svm')
    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i+12*6, 2, 2, num_features[i], 'tf', 'svm')
    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i+12*7, 2, 2, num_features[i], 'stopwords', 'svm')
