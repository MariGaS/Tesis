...
for i in range(10):
    run_experiment_anorexia(data_anxia, labels_anxia, ntrain, test_labels_anxia, i+10*100, 
                            3,3,arg1[i],arg2[i],1,arg4[i],'binary', 'NB','normal_preprocess')
    run_experiment_anorexia(data_anxia, labels_anxia, ntrain, test_labels_anxia, i+10*101, 
                            3,3,arg1[i],arg2[i],1,arg4[i],'tf_stop', 'NB', 'normal_preprocess')
    run_experiment_anorexia(data_anxia, labels_anxia, ntrain, test_labels_anxia, i+10*102, 
                            3,3,arg1[i],arg2[i],1,arg4[i],'tf', 'NB', 'normal_preprocess')
    run_experiment_anorexia(data_anxia, labels_anxia, ntrain, test_labels_anxia, i+10*103, 
                            3,3,arg1[i],arg2[i],1,arg4[i],'stopwords', 'NB', 'normal_preprocess')
    run_experiment_anorexia(data_anxia, labels_anxia, ntrain, test_labels_anxia, i+10*104, 
                            3,3,arg1[i],arg2[i],1,arg4[i],'tf_idf', 'NB', 'normal_preprocess')
    run_experiment_anorexia(data_anxia, labels_anxia, ntrain, test_labels_anxia, i+10*105, 
                            3,3,arg1[i],arg2[i],1,arg4[i],'binary', 'svm', 'normal_preprocess')
    run_experiment_anorexia(data_anxia, labels_anxia, ntrain, test_labels_anxia, i+10*106, 
                            3,3,arg1[i],arg2[i],1,arg4[i],'tf_stop', 'svm', 'normal_preprocess')
    run_experiment_anorexia(data_anxia, labels_anxia, ntrain, test_labels_anxia, i+10*107, 
                            3,3,arg1[i],arg2[i],1,arg4[i],'tf', 'svm', 'normal_preprocess')
    run_experiment_anorexia(data_anxia, labels_anxia, ntrain, test_labels_anxia, i+10*108, 
                            3,3,arg1[i],arg2[i],1,arg4[i],'stopwords', 'svm', 'normal_preprocess')
    run_experiment_anorexia(data_anxia, labels_anxia, ntrain, test_labels_anxia, i+10*109, 
                            3,3,arg1[i],arg2[i],1,arg4[i],'tf_idf', 'svm','normal_preprocess')
    
    #dic == 2
    run_experiment_anorexia(data_anxia, labels_anxia, ntrain, test_labels_anxia, i+10*110, 
                            3,3,arg1[i],arg2[i],2,arg4[i],'binary', 'NB','normal_preprocess')
    run_experiment_anorexia(data_anxia, labels_anxia, ntrain, test_labels_anxia, i+10*111, 
                            3,3,arg1[i],arg2[i],2,arg4[i],'tf_stop', 'NB', 'normal_preprocess')
    run_experiment_anorexia(data_anxia, labels_anxia, ntrain, test_labels_anxia, i+10*112, 
                            3,3,arg1[i],arg2[i],2,arg4[i],'tf', 'NB', 'normal_preprocess')
    run_experiment_anorexia(data_anxia, labels_anxia, ntrain, test_labels_anxia, i+10*113, 
                            3,3,arg1[i],arg2[i],2,arg4[i],'stopwords', 'NB', 'normal_preprocess')
    run_experiment_anorexia(data_anxia, labels_anxia, ntrain, test_labels_anxia, i+10*114, 
                            3,3,arg1[i],arg2[i],2,arg4[i],'tf_idf', 'NB', 'normal_preprocess')
    run_experiment_anorexia(data_anxia, labels_anxia, ntrain, test_labels_anxia, i+10*115, 
                            3,3,arg1[i],arg2[i],2,arg4[i],'binary', 'svm', 'normal_preprocess')
    run_experiment_anorexia(data_anxia, labels_anxia, ntrain, test_labels_anxia, i+10*116, 
                            3,3,arg1[i],arg2[i],2,arg4[i],'tf_stop', 'svm', 'normal_preprocess')
    run_experiment_anorexia(data_anxia, labels_anxia, ntrain, test_labels_anxia, i+10*117, 
                            3,3,arg1[i],arg2[i],2,arg4[i],'tf', 'svm', 'normal_preprocess')
    run_experiment_anorexia(data_anxia, labels_anxia, ntrain, test_labels_anxia, i+10*118, 
                            3,3,arg1[i],arg2[i],2,arg4[i],'stopwords', 'svm', 'normal_preprocess')
    run_experiment_anorexia(data_anxia, labels_anxia, ntrain, test_labels_anxia, i+10*119, 
                            3,3,arg1[i],arg2[i],2,arg4[i],'tf_idf', 'svm','normal_preprocess')    