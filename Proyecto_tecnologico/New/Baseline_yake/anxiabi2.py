...
for i in range(10):
    run_experiment_anorexia(data_anxia, labels_anxia, ntrain, test_labels_anxia, i+10*5, 
                            1,2,arg1[i],arg2[i],arg3[i],arg4[i],'binary', 'svm', 'ekphrasis_preprocess', bi = True)
    
    run_experiment_anorexia(data_anxia, labels_anxia, ntrain, test_labels_anxia, i+10*6, 
                            1,2,arg1[i],arg2[i],arg3[i],arg4[i],'tf_stop', 'svm','ekphrasis_preprocess', bi = True)
    run_experiment_anorexia(data_anxia, labels_anxia, ntrain, test_labels_anxia, i+10*7, 
                            1,2,arg1[i],arg2[i],arg3[i],arg4[i],'tf', 'svm', 'ekphrasis_preprocess', bi = True)
    run_experiment_anorexia(data_anxia, labels_anxia, ntrain, test_labels_anxia, i+10*8, 
                            1,2,arg1[i],arg2[i],arg3[i],arg4[i],'stopwords', 'svm', 'ekphrasis_preprocess', bi = True)
    run_experiment_anorexia(data_anxia, labels_anxia, ntrain, test_labels_anxia, i+10*9, 
                            1,2,arg1[i],arg2[i],arg3[i],arg4[i],'tf_idf', 'svm', 'ekphrasis_preprocess', bi = True)