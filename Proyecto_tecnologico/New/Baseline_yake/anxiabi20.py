...
for i in range(10):
    run_experiment_anorexia(data_anxia, labels_anxia, ntrain, test_labels_anxia, i+10*150, 
                            2,2,arg1[i],arg2[i],arg3[i],arg4[i],'binary', 'NB','normal_preprocess')
    run_experiment_anorexia(data_anxia, labels_anxia, ntrain, test_labels_anxia, i+10*151, 
                            2,2,arg1[i],arg2[i],arg3[i],arg4[i],'tf_stop', 'NB', 'normal_preprocess')
    run_experiment_anorexia(data_anxia, labels_anxia, ntrain, test_labels_anxia, i+10*152, 
                            2,2,arg1[i],arg2[i],arg3[i],arg4[i],'tf', 'NB', 'normal_preprocess')
    run_experiment_anorexia(data_anxia, labels_anxia, ntrain, test_labels_anxia, i+10*153, 
                            2,2,arg1[i],arg2[i],arg3[i],arg4[i],'stopwords', 'NB', 'normal_preprocess')
    run_experiment_anorexia(data_anxia, labels_anxia, ntrain, test_labels_anxia, i+10*154, 
                            2,2,arg1[i],arg2[i],arg3[i],arg4[i],'tf_idf', 'NB', 'normal_preprocess')
    run_experiment_anorexia(data_anxia, labels_anxia, ntrain, test_labels_anxia, i+10*155, 
                            2,2,arg1[i],arg2[i],arg3[i],arg4[i],'binary', 'svm', 'normal_preprocess')
    run_experiment_anorexia(data_anxia, labels_anxia, ntrain, test_labels_anxia, i+10*156, 
                            2,2,arg1[i],arg2[i],arg3[i],arg4[i],'tf_stop', 'svm', 'normal_preprocess')
    run_experiment_anorexia(data_anxia, labels_anxia, ntrain, test_labels_anxia, i+10*157, 
                            2,2,arg1[i],arg2[i],arg3[i],arg4[i],'tf', 'svm', 'normal_preprocess')
    run_experiment_anorexia(data_anxia, labels_anxia, ntrain, test_labels_anxia, i+10*158, 
                            2,2,arg1[i],arg2[i],arg3[i],arg4[i],'stopwords', 'svm', 'normal_preprocess')
    run_experiment_anorexia(data_anxia, labels_anxia, ntrain, test_labels_anxia, i+10*159, 
