...
for i in range(5):
    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i+5*0, 
                            1,1,arg1[i],arg2[i],arg3[i],arg4[i],'binary', 'NB')
    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i+5*1, 
                            1,1,arg1[i],arg2[i],arg3[i],arg4[i],'tf_stop', 'NB')
    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i+5*2, 
                            1,1,arg1[i],arg2[i],arg3[i],arg4[i],'tf', 'NB')
    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i+5*3, 
                            1,1,arg1[i],arg2[i],arg3[i],arg4[i],'stopwords', 'NB')
    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i+5*4, 
                            1,1,arg1[i],arg2[i],arg3[i],arg4[i],'tf_idf', 'NB')