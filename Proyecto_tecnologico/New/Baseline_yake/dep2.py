...
for i in range(5):
    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i+5*5, 
                            1,1,arg1[i],arg2[i],arg3[i],arg4[i],'binary', 'svm')
    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i+5*6, 
                            1,1,arg1[i],arg2[i],arg3[i],arg4[i],'tf_stop', 'svm')
    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i+5*7, 
                            1,1,arg1[i],arg2[i],arg3[i],arg4[i],'tf', 'svm')
    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i+5*8, 
                            1,1,arg1[i],arg2[i],arg3[i],arg4[i],'stopwords', 'svm')
    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i+5*9, 
                            1,1,arg1[i],arg2[i],arg3[i],arg4[i],'tf_idf', 'svm')