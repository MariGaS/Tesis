...
for i in range(10):
    ...
    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i+10*11, 
                            1,2,arg1[i],arg2[i],arg3[i],arg4[i],'tf_stop', 'NB')
    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i+10*12, 
                            1,2,arg1[i],arg2[i],arg3[i],arg4[i],'tf', 'NB')
    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i+10*13, 
