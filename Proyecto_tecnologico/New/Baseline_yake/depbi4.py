...
for i in range(10):
    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i+10*30, 
                            2,2,arg1[i],arg2[i],arg3[i],arg4[i],'binary', 'NB')
    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i+10*31, 
                            2,2,arg1[i],arg2[i],arg3[i],arg4[i],'tf_stop', 'NB')
    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i+10*32, 
                            2,2,arg1[i],arg2[i],arg3[i],arg4[i],'tf', 'NB')
    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i+10*33, 
                            2,2,arg1[i],arg2[i],arg3[i],arg4[i],'stopwords', 'NB')
    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i+10*34, 
                            2,2,arg1[i],arg2[i],arg3[i],arg4[i],'tf_idf', 'NB')
    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i+10*35, 
                            2,2,arg1[i],arg2[i],arg3[i],arg4[i],'binary', 'svm')
    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i+10*36, 
                            2,2,arg1[i],arg2[i],arg3[i],arg4[i],'tf_stop', 'svm')
    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i+10*37, 
                            2,2,arg1[i],arg2[i],arg3[i],arg4[i],'tf', 'svm')
    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i+10*38, 
                            2,2,arg1[i],arg2[i],arg3[i],arg4[i],'stopwords', 'svm')
    run_experiment_depression(data_dep, labels_dep, ntrain, test_labels, i+10*39, 
