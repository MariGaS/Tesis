...
name_key = '/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/New/Con_dictionary/anxia_pos_ver3'
...
name_key = '/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/New/Con_dictionary/anxia_neg_ver3'
with open(name_key, 'wb') as f:
	pickle.dump(keywords1, f)
	f.close()
...
name_key = '/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/New/Con_dictionary/anxia_pos_ver4'
with open(name_key, 'wb') as f:
	pickle.dump(keywords1, f)
	f.close()
...
name_key = '/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/New/Con_dictionary/anxia_neg_ver4'
with open(name_key, 'wb') as f:
	pickle.dump(keywords1, f)
	f.close()
