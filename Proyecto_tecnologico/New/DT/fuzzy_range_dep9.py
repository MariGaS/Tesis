...
for i in range(10):
    f = run_exp_dep_sim(i+150,test_labels, train_y,num_test,num_train,arg1[i],arg2[i],tau=arg3[i],
                                chose =2,add =arg9[i],groups=arg10[i], dif = False, fuzzy= arg6[i],remove_stop=arg7[i], 
                                compress=False, dic =arg8[i], tf = False,clustering= arg11[i], w_clustering= True)
