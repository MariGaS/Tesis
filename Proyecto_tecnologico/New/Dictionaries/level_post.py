...
## MAKE DICTIONARIES FOR DEPRESSION 
...
for i in range(len(arg1)):
    name_path1 = '/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/New/Dictionaries/Level_post/No_difference/Uppercase/pos_anxia_' +str(arg1[i])
    name_path2 = '/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/New/Dictionaries/Level_post/No_difference/Uppercase/neg_anxia_' + str(arg2[i])

    get_dictionary(name_path1, name_path2, pos_anxia1, neg_anxia1, arg1[i], arg2[i], no_distintic= True, con = False)

    name_path3 = '/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/New/Dictionaries/Level_post/Difference/Lowercase/pos_anxia_' +str(arg1[i])
    name_path4 = '/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/New/Dictionaries/Level_post/Difference/Lowercase/neg_anxia_' + str(arg2[i])

    get_dictionary(name_path3, name_path4, pos_anxia2, neg_anxia2, arg1[i], arg2[i], no_distintic= False, con = False)
...
for i in range(len(arg1)):
    name_path1 = '/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/New/Dictionaries/Level_post/No_difference/Uppercase/pos_dep_' +str(arg1[i])
    name_path2 = '/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/New/Dictionaries/Level_post/No_difference/Uppercase/neg_dep_' + str(arg2[i])

    get_dictionary(name_path1, name_path2, pos_dep1, neg_dep1, arg1[i], arg2[i], no_distintic= True, con = False)

    name_path3 = '/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/New/Dictionaries/Level_post/Difference/Lowercase/pos_dep_' +str(arg1[i])
    name_path4 = '/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/New/Dictionaries/Level_post/Difference/Lowercase/neg_dep_' + str(arg2[i])

    get_dictionary(name_path3, name_path4, pos_dep2, neg_dep2, arg1[i], arg2[i], no_distintic= False, con = False)
