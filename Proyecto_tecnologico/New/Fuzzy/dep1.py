...
for i in range(24):
    f,x= run_exp_dep_sim(i+1, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=False,compress=False, dic = 1, tf = True)

    f,x= run_exp_dep_sim(i+25, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =3,dif = False, fuzzy= arg5[i],remove_stop=False,compress=False, dic = 1, tf = True)

    f,x= run_exp_dep_sim(i+49, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=False,compress=True, dic = 1, tf = True)
    f,x= run_exp_dep_sim(i+73, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =3,dif = False, fuzzy= arg5[i],remove_stop=False,compress=True, dic = 1, tf = True)


    f,x= run_exp_dep_sim(i+97, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=True,compress=False, dic = 1, tf = True)

    f,x= run_exp_dep_sim(i+121, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =3,dif = False, fuzzy= arg5[i],remove_stop=True,compress=False, dic = 1, tf = True)

    f,x= run_exp_dep_sim(i+145, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=True,compress=True, dic = 1, tf = True)
    f,x= run_exp_dep_sim(i+169, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
