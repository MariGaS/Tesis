...
for i in range(24):
    f,x= run_exp_dep_sim(i+577, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=False,compress=False, dic = 4, tf = True)

    f,x= run_exp_dep_sim(i+601, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =3,dif = False, fuzzy= arg5[i],remove_stop=False,compress=False, dic = 4, tf = True)

    f,x= run_exp_dep_sim(i+625, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=False,compress=True, dic = 4, tf = True)
    f,x= run_exp_dep_sim(i+649, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =3,dif = False, fuzzy= arg5[i],remove_stop=False,compress=True, dic = 4, tf = True)


    f,x= run_exp_dep_sim(i+673, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=True,compress=False, dic = 4, tf = True)

    f,x= run_exp_dep_sim(i+697, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =3,dif = False, fuzzy= arg5[i],remove_stop=True,compress=False, dic = 4, tf = True)

    f,x= run_exp_dep_sim(i+721, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=True,compress=True, dic = 4, tf = True)
    f,x= run_exp_dep_sim(i+745, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
