...
for i in range(4):
    f = run_exp_dep_sim(i+4*65,test_labels, train_y,num_test,num_train,name_dic='dict5',tau=arg3[i],
                            chose =2, fuzzy= arg5[i],remove_stop=arg6[i], only_bow=False, tf = True,classificator='NB')

    f = run_exp_dep_sim(i+4*66,test_labels, train_y,num_test,num_train,name_dic='dict6',tau=arg3[i],
                            chose =2, fuzzy= arg5[i],remove_stop=arg6[i], only_bow=False, tf = True,classificator='NB')

    f = run_exp_dep_sim(i+4*67,test_labels, train_y,num_test,num_train,name_dic='dict7',tau=arg3[i],
                            chose =2, fuzzy= arg5[i],remove_stop=arg6[i], only_bow=False, tf = True,classificator='NB')

    f = run_exp_dep_sim(i+4*68,test_labels, train_y,num_test,num_train,name_dic='dict8',tau=arg3[i],
                            chose =2, fuzzy= arg5[i],remove_stop=arg6[i],only_bow=False,  tf = True,classificator='NB')

    f = run_exp_dep_sim(i+4*69,test_labels, train_y,num_test,num_train,name_dic='dict5',tau=arg3[i],
                            chose =2, fuzzy= arg5[i],remove_stop=arg6[i],only_bow=False,  tf = False,classificator='NB')

    f = run_exp_dep_sim(i+4*70,test_labels, train_y,num_test,num_train,name_dic='dict6',tau=arg3[i],
                            chose =2, fuzzy= arg5[i],remove_stop=arg6[i],only_bow=False,  tf = False,classificator='NB')

    f = run_exp_dep_sim(i+4*71,test_labels,train_y,num_test,num_train,name_dic='dict7',tau=arg3[i],
                            chose =2, fuzzy= arg5[i],remove_stop=arg6[i], only_bow=False, tf = False,classificator='NB')

    f = run_exp_dep_sim(i+4*72,test_labels, train_y,num_test,num_train,name_dic='dict8',tau=arg3[i],
                            chose =2, fuzzy= arg5[i],remove_stop=arg6[i],only_bow=False,  tf = False,classificator='NB')
    f = run_exp_dep_sim(i+4*73,test_labels, train_y,num_test,num_train,name_dic='dict5',tau=arg3[i],
                            chose =3, fuzzy= arg5[i],remove_stop=arg6[i], only_bow=False, tf = True,classificator='NB')

    f = run_exp_dep_sim(i+4*74,test_labels, train_y,num_test,num_train,name_dic='dict6',tau=arg3[i],
                            chose =3, fuzzy= arg5[i],remove_stop=arg6[i], only_bow=False, tf = True,classificator='NB')

    f = run_exp_dep_sim(i+4*75,test_labels, train_y,num_test,num_train,name_dic='dict7',tau=arg3[i],
                            chose =3, fuzzy= arg5[i],remove_stop=arg6[i], only_bow=False, tf = True,classificator='NB')

    f = run_exp_dep_sim(i+4*76,test_labels, train_y,num_test,num_train,name_dic='dict8',tau=arg3[i],
                            chose =3, fuzzy= arg5[i],remove_stop=arg6[i], only_bow=False, tf = True,classificator='NB')

    f = run_exp_dep_sim(i+4*77,test_labels, train_y,num_test,num_train,name_dic='dict5',tau=arg3[i],
                            chose =3, fuzzy= arg5[i],remove_stop=arg6[i], only_bow=False, tf = False,classificator='NB')

    f = run_exp_dep_sim(i+4*78,test_labels, train_y,num_test,num_train,name_dic='dict6',tau=arg3[i],
                            chose =3, fuzzy= arg5[i],remove_stop=arg6[i], only_bow=False, tf = False,classificator='NB')

    f = run_exp_dep_sim(i+4*79,test_labels,train_y,num_test,num_train,name_dic='dict7',tau=arg3[i],
                            chose =3, fuzzy= arg5[i],remove_stop=arg6[i], only_bow=False, tf = False,classificator='NB')

    f = run_exp_dep_sim(i+4*80,test_labels, train_y,num_test,num_train,name_dic='dict8',tau=arg3[i],
                            chose =3, fuzzy= arg5[i],remove_stop=arg6[i], only_bow=False,tf = False,classificator='NB')