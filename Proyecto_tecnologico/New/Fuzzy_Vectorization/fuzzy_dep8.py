...
for i in range(4):
    f = run_exp_dep_sim(i+(4*153),test_labels, train_y,num_test,num_train,name_dic='dict5',tau=arg3[i],
                            chose =2, fuzzy= arg5[i],remove_stop=arg6[i],  tf = True,classificator='NB')

    f = run_exp_dep_sim(i+(4*154),test_labels, train_y,num_test,num_train,name_dic='dict6',tau=arg3[i],
                            chose =2, fuzzy= arg5[i],remove_stop=arg6[i],  tf = True,classificator='NB')

    f = run_exp_dep_sim(i+(4*155),test_labels, train_y,num_test,num_train,name_dic='dict7',tau=arg3[i],
                            chose =2, fuzzy= arg5[i],remove_stop=arg6[i],  tf = True,classificator='NB')

    f = run_exp_dep_sim(i+(4*156),test_labels, train_y,num_test,num_train,name_dic='dict8',tau=arg3[i],
                            chose =2, fuzzy= arg5[i],remove_stop=arg6[i],  tf = True,classificator='NB')

    f = run_exp_dep_sim(i+(4*157),test_labels, train_y,num_test,num_train,name_dic='dict5',tau=arg3[i],
                            chose =2, fuzzy= arg5[i],remove_stop=arg6[i],  tf = False,classificator='NB')

    f = run_exp_dep_sim(i+(4*158),test_labels, train_y,num_test,num_train,name_dic='dict6',tau=arg3[i],
                            chose =2, fuzzy= arg5[i],remove_stop=arg6[i],  tf = False,classificator='NB')

    f = run_exp_dep_sim(i+(4*159),test_labels,train_y,num_test,num_train,name_dic='dict7',tau=arg3[i],
                            chose =2, fuzzy= arg5[i],remove_stop=arg6[i],  tf = False,classificator='NB')

    f = run_exp_dep_sim(i+(4*160),test_labels, train_y,num_test,num_train,name_dic='dict8',tau=arg3[i],
                            chose =2, fuzzy= arg5[i],remove_stop=arg6[i],  tf = False,classificator='NB')