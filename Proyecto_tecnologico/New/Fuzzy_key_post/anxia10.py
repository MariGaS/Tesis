...
for i in range(12):
    f = run_exp_anxia_sim(i+445, test_labels_anxia, tr_label,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
...
for i in range(12):
    f = run_exp_anxia_sim(i+469, test_labels_anxia, tr_label,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
