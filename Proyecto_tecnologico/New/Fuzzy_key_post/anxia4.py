...
for i in range(12):
    f = run_exp_anxia_sim(i+145,test_labels_anxia, tr_label,num_test,num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =3,dif = True, fuzzy= arg5[i],remove_stop=arg6[i], compress=False, dic =2)

    
for i in range(12):
    f = run_exp_anxia_sim(i+157, test_labels_anxia, tr_label,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =3,dif = True, fuzzy= arg5[i],remove_stop=arg7[i],compress=False, dic =2)
    
#en este si importa 
for i in range(12):
    f = run_exp_anxia_sim(i+169, test_labels_anxia, tr_label,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =3,dif = False, fuzzy= arg5[i],remove_stop=arg6[i], compress=False, dic= 2)
    


for i in range(12):
    f= run_exp_anxia_sim(i+181, test_labels_anxia, tr_label,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =3,dif = False, fuzzy= arg5[i],remove_stop=arg7[i],compress=False, dic = 2)
