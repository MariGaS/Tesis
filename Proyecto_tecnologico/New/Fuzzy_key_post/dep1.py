...
for i in range(24):
    f,x,y,z= run_exp_dep_sim(i+2001, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=False,compress=False, dic = 1)

    f,x,y,z= run_exp_dep_sim(i+2025, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =3,dif = False, fuzzy= arg5[i],remove_stop=False,compress=False, dic = 1)

    f,x,y,z= run_exp_dep_sim(i+2049, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=False,compress=True, dic = 1)
    f,x,y,z= run_exp_dep_sim(i+2073, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =3,dif = False, fuzzy= arg5[i],remove_stop=False,compress=True, dic = 1)


    f,x,y,z= run_exp_dep_sim(i+2097, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=True,compress=False, dic = 1)

    f,x,y,z= run_exp_dep_sim(i+2121, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =3,dif = False, fuzzy= arg5[i],remove_stop=True,compress=False, dic = 1)

    f,x,y,z= run_exp_dep_sim(i+2145, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=True,compress=True, dic = 1)
    f,x,y,z= run_exp_dep_sim(i+2169, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
