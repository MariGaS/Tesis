...
for i in range(24):
    f,x,y,z= run_exp_dep_sim(i+2193, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=False,compress=False, dic =2)

    f,x,y,z= run_exp_dep_sim(i+2217, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =3,dif = False, fuzzy= arg5[i],remove_stop=False,compress=False, dic = 2)

    f,x,y,z= run_exp_dep_sim(i+2241, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=False,compress=True, dic = 2)
    f,x,y,z= run_exp_dep_sim(i+2265, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =3,dif = False, fuzzy= arg5[i],remove_stop=False,compress=True, dic = 2)


    f,x,y,z= run_exp_dep_sim(i+2289, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=True,compress=False, dic = 2)

    f,x,y,z= run_exp_dep_sim(i+2313, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =3,dif = False, fuzzy= arg5[i],remove_stop=True,compress=False, dic = 2)

    f,x,y,z= run_exp_dep_sim(i+2337, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=True,compress=True, dic = 2)
    f,x,y,z= run_exp_dep_sim(i+2361, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
