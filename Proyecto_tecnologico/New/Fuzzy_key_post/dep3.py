...
for i in range(24):
    f,x,y,z= run_exp_dep_sim(i+2385, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=False,compress=False, dic =3)

    f,x,y,z= run_exp_dep_sim(i+2409, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =3,dif = False, fuzzy= arg5[i],remove_stop=False,compress=False, dic = 3)

    f,x,y,z= run_exp_dep_sim(i+2433, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=False,compress=True, dic = 3)
    f,x,y,z= run_exp_dep_sim(i+2457, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =3,dif = False, fuzzy= arg5[i],remove_stop=False,compress=True, dic = 3)


    f,x,y,z= run_exp_dep_sim(i+2481, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=True,compress=False, dic = 3)

    f,x,y,z= run_exp_dep_sim(i+2505, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =3,dif = False, fuzzy= arg5[i],remove_stop=True,compress=False, dic = 3)

    f,x,y,z= run_exp_dep_sim(i+2529, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=True,compress=True, dic = 3)
    f,x,y,z= run_exp_dep_sim(i+2553, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
