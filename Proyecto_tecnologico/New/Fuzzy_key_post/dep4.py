...
for i in range(24):
    f,x,y,z= run_exp_dep_sim(i+2577, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=False,compress=False, dic =4)

    f,x,y,z= run_exp_dep_sim(i+2601, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =3,dif = False, fuzzy= arg5[i],remove_stop=False,compress=False, dic = 4)

    f,x,y,z= run_exp_dep_sim(i+2625, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=False,compress=True, dic = 4)
    f,x,y,z= run_exp_dep_sim(i+2649, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =3,dif = False, fuzzy= arg5[i],remove_stop=False,compress=True, dic = 4)


    f,x,y,z= run_exp_dep_sim(i+2673, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=True,compress=False, dic = 4)

    f,x,y,z= run_exp_dep_sim(i+2697, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =3,dif = False, fuzzy= arg5[i],remove_stop=True,compress=False, dic = 4)

    f,x,y,z= run_exp_dep_sim(i+2721, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=True,compress=True, dic = 4)
    f,x,y,z= run_exp_dep_sim(i+2745, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],
