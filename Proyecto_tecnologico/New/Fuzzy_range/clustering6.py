...
# con_dep1 = get_represententing_words(con_dep_emb_matrix_pos1, 20, words_pos_dep5)
# with open(cluster_path_5+'/con_dep_uppercase', "wb") as fp:
#     pickle.dump(con_dep1, fp)
#     fp.close()

# con_dep2 = get_represententing_words(con_dep_emb_matrix_pos2, 20, words_pos_dep5)
# with open(cluster_path_5+'/con_dep_pre_uppercase', "wb") as fp:
#     pickle.dump(con_dep2, fp)
#     fp.close()

# con_dep3 = get_represententing_words(con_dep_emb_matrix_pos3, 20, words_pos_dep5)
# with open(cluster_path_5+'/con_dep_emo_uppercase', "wb") as fp:
#     pickle.dump(con_dep3, fp)
#     fp.close()

# con_dep4 = get_represententing_words(con_dep_emb_matrix_pos4, 20, words_pos_dep6)
# with open(cluster_path_5+'/con_dep_lowercase', "wb") as fp:
#     pickle.dump(con_dep4, fp)
#     fp.close()
    
# con_dep5 = get_represententing_words(con_dep_emb_matrix_pos5, 20, words_pos_dep6)
# with open(cluster_path_5+'/con_dep_pre_lowercase', "wb") as fp:
#     pickle.dump(con_dep5, fp)
#     fp.close()

# con_dep6 = get_represententing_words(con_dep_emb_matrix_pos6, 20, words_pos_dep6)
# with open(cluster_path_5+'/con_dep_emo_lowercase', "wb") as fp:
#     pickle.dump(con_dep6, fp)
#     fp.close()

# con_dep1 = get_represententing_words(con_dep_emb_matrix_neg1, 20, words_neg_dep5)
# with open(cluster_path_5+'/con_neg_dep_uppercase', "wb") as fp:
#     pickle.dump(con_dep1, fp)
#     fp.close()

# con_dep2 = get_represententing_words(con_dep_emb_matrix_neg2, 20, words_neg_dep5)
# with open(cluster_path_5+'/con_neg_dep_pre_uppercase', "wb") as fp:
#     pickle.dump(con_dep2, fp)
#     fp.close()

# con_dep3 = get_represententing_words(con_dep_emb_matrix_neg3, 20, words_neg_dep5)
# with open(cluster_path_5+'/con_neg_dep_emo_uppercase', "wb") as fp:
#     pickle.dump(con_dep3, fp)
#     fp.close()

# con_dep4 = get_represententing_words(con_dep_emb_matrix_neg4, 20, words_neg_dep6)
# with open(cluster_path_5+'/con_neg_dep_lowercase', "wb") as fp:
#     pickle.dump(con_dep4, fp)
#     fp.close()

# con_dep5 = get_represententing_words(user_dep_emb_matrix_neg5, 20, words_neg_dep6)
# with open(cluster_path_5+'/con_neg_dep_pre_lowercase', "wb") as fp:
#     pickle.dump(con_dep5, fp)
#     fp.close()

# con_dep6 = get_represententing_words(con_dep_emb_matrix_neg6, 20, words_neg_dep6)
...
post_dep5 = get_represententing_words(post_dep_emb_matrix_neg5,20, words_neg_dep2)
with open(cluster_path_5+'/post_neg_dep_pre_lowercase', "wb") as fp:
    pickle.dump(post_dep5, fp)
    fp.close()

post_dep6 = get_represententing_words(post_dep_emb_matrix_neg6, 20, words_neg_dep2)
