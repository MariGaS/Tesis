...
arg1 = [200,100,500,200,200,700,500,500,100]
arg2 = [200,200,100,200,200,500,500,500,100] #score2
arg3 = [0.95]*9
...
for i in range(10):
    f = run_exp_dep_sim(i+100,test_labels, train_y,num_test,num_train,arg1[i],arg2[i],tau=arg3[i],
