...
arg1 = [200,500,100,200,200,700,100,500,100]
arg2 = [200,200,100,200,200,500,100,500,100] #score2
arg3 = [0.95]*9
...
for i in range(10):
    f = run_exp_dep_sim(i+110,test_labels, train_y,num_test,num_train,arg1[i],arg2[i],tau=arg3[i],
