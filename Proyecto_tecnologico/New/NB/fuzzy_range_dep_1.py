...
arg1 = [2000,15000,1500,2000,2000,1700,1500,1500,1500]
arg2 = [2000,2000,1500,2000,2000,1500,1500,1500,1500] #score2
arg3 = [0.95]*9
arg6 = [True,False,True,True,False,False,True,False,False] #fuzzy 
arg7 = [False]*9
arg8 = [4,
2,
2,
...
2,
2]
arg9 = ['negative','negative','both','negative','positive','negative','both','both','both']
arg10 = [[5],[10],[5,10],[5],[5],[5],[5,10],[5,10],[5,10]]
print('Begins experiments')
# En este no importa si hay en común
for i in range(10):
    f = run_exp_dep_sim(i+20,test_labels, train_y,num_test,num_train,arg1[i],arg2[i],tau=arg3[i],
                                chose =2,add =arg9[i],groups=arg10[i], dif = False, fuzzy= arg6[i],remove_stop=arg7[i], 
                                compress=False, dic =arg8[i], tf = False,clustering= 'simple', w_clustering= False)
