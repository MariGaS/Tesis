...
for i in range(24):
    f = run_exp_anxia_sim(i+4385,test_labels_anxia, tr_label,num_test,num_train,arg1[i],arg2[i],tau=arg3[i], groups=5,
                            chose =1,dif = True, fuzzy= arg5[i],remove_stop=True, compress=False, dic =3)

    f = run_exp_anxia_sim(i+4433, test_labels_anxia, tr_label,num_test, num_train,arg1[i],arg2[i],tau=arg3[i], groups=5,
                            chose =1,dif = True, fuzzy= arg5[i],remove_stop=False,compress=False, dic =3)
    
    f = run_exp_anxia_sim(i+4457, test_labels_anxia, tr_label,num_test, num_train,arg1[i],arg2[i],tau=arg3[i], groups=5,
                            chose =3,dif = False, fuzzy= arg5[i],remove_stop=True, compress=False, dic= 3)

    f= run_exp_anxia_sim(i+4481, test_labels_anxia, tr_label,num_test, num_train,arg1[i],arg2[i],tau=arg3[i], groups=5,
                            chose =3,dif = False, fuzzy= arg5[i],remove_stop=False,compress=False, dic = 3)
    f = run_exp_anxia_sim(i+4505,test_labels_anxia, tr_label,num_test,num_train,arg1[i],arg2[i],tau=arg3[i], groups= 5,
                            chose =1,dif = True, fuzzy= arg5[i],remove_stop=True, compress=True, dic =3)

    f = run_exp_anxia_sim(i+4529, test_labels_anxia, tr_label,num_test, num_train,arg1[i],arg2[i],tau=arg3[i], groups=5,
                            chose =1,dif = True, fuzzy= arg5[i],remove_stop=False,compress=True, dic =3)
    
    f = run_exp_anxia_sim(i+4553, test_labels_anxia, tr_label,num_test, num_train,arg1[i],arg2[i],tau=arg3[i], groups= 5,
                            chose =3,dif = False, fuzzy= arg5[i],remove_stop=True, compress=True, dic= 3)

    f= run_exp_anxia_sim(i+4577, test_labels_anxia, tr_label,num_test, num_train,arg1[i],arg2[i],tau=arg3[i], groups= 5,
