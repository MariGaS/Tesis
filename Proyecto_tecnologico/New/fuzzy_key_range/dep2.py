...
for i in range(24):
    f,x,y,z= run_exp_dep_sim(i+193, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],groups=20,
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=False,compress=False, dic =2)

    f,x,y,z= run_exp_dep_sim(i+217, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],groups=20,
                            chose =3,dif = False, fuzzy= arg5[i],remove_stop=False,compress=False, dic = 2)

    f,x,y,z= run_exp_dep_sim(i+241, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],groups=20,
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=False,compress=True, dic = 2)
    f,x,y,z= run_exp_dep_sim(i+265, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],groups=20,
                            chose =3,dif = False, fuzzy= arg5[i],remove_stop=False,compress=True, dic = 2)


    f,x,y,z= run_exp_dep_sim(i+289, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],groups=20,
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=True,compress=False, dic = 2)

    f,x,y,z= run_exp_dep_sim(i+313, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],groups=20,
                            chose =3,dif = False, fuzzy= arg5[i],remove_stop=True,compress=False, dic = 2)

    f,x,y,z= run_exp_dep_sim(i+337, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],groups=20,
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=True,compress=True, dic = 2)
    f,x,y,z= run_exp_dep_sim(i+361, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],groups=20,
