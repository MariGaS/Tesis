...
for i in range(24):
    f,x,y,z= run_exp_dep_sim(i+385, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],groups=20,
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=False,compress=False, dic =3)

    f,x,y,z= run_exp_dep_sim(i+409, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],groups=20,
                            chose =3,dif = False, fuzzy= arg5[i],remove_stop=False,compress=False, dic = 3)

    f,x,y,z= run_exp_dep_sim(i+433, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],groups=20,
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=False,compress=True, dic = 3)
    f,x,y,z= run_exp_dep_sim(i+457, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],groups=20,
                            chose =3,dif = False, fuzzy= arg5[i],remove_stop=False,compress=True, dic = 3)


    f,x,y,z= run_exp_dep_sim(i+481, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],groups=20,
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=True,compress=False, dic = 3)

    f,x,y,z= run_exp_dep_sim(i+505, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],groups=20,
                            chose =3,dif = False, fuzzy= arg5[i],remove_stop=True,compress=False, dic = 3)

    f,x,y,z= run_exp_dep_sim(i+529, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],groups=20,
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=True,compress=True, dic = 3)
    f,x,y,z= run_exp_dep_sim(i+553, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],groups=20,
