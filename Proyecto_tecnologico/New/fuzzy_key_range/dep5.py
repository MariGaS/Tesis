...
for i in range(24):
    f,x,y,z= run_exp_dep_sim(i+769, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i], groups=20,
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=False,compress=False, dic =5)

    f,x,y,z= run_exp_dep_sim(i+793, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i], groups=20,
                            chose =3,dif = False, fuzzy= arg5[i],remove_stop=False,compress=False, dic = 5)

    f,x,y,z= run_exp_dep_sim(i+817, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i], groups=20,
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=False,compress=True, dic = 5)
    f,x,y,z= run_exp_dep_sim(i+841, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i], groups=20,
                            chose =3,dif = False, fuzzy= arg5[i],remove_stop=False,compress=True, dic = 5)


    f,x,y,z= run_exp_dep_sim(i+865, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i], groups=20,
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=True,compress=False, dic = 5)

    f,x,y,z= run_exp_dep_sim(i+889, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i], groups=20,
                            chose =3,dif = False, fuzzy= arg5[i],remove_stop=True,compress=False, dic = 5)

    f,x,y,z= run_exp_dep_sim(i+913, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i], groups=20,
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=True,compress=True, dic = 5)
    f,x,y,z= run_exp_dep_sim(i+937, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i], groups=20,
