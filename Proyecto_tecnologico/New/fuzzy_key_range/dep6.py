...
for i in range(24):
    f,x,y,z= run_exp_dep_sim(i+961, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],groups=20,
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=False,compress=False, dic =6)

    f,x,y,z= run_exp_dep_sim(i+985, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],groups=20,
                            chose =3,dif = False, fuzzy= arg5[i],remove_stop=False,compress=False, dic = 6)

    f,x,y,z= run_exp_dep_sim(i+1009, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],groups=20,
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=False,compress=True, dic = 6)
    f,x,y,z= run_exp_dep_sim(i+1033, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],groups=20,
                            chose =3,dif = False, fuzzy= arg5[i],remove_stop=False,compress=True, dic = 6)


    f,x,y,z= run_exp_dep_sim(i+1057, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],groups=20,
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=True,compress=False, dic = 6)

    f,x,y,z= run_exp_dep_sim(i+1081, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],groups=20,
                            chose =3,dif = False, fuzzy= arg5[i],remove_stop=True,compress=False, dic = 6)

    f,x,y,z= run_exp_dep_sim(i+1105, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],groups=20,
                            chose =2,dif = False, fuzzy= arg5[i],remove_stop=True,compress=True, dic = 6)
    f,x,y,z= run_exp_dep_sim(i+1129, test_labels, train_y,num_test, num_train,arg1[i],arg2[i],tau=arg3[i],groups=20,
