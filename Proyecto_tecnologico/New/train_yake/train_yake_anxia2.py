...
for i in range(len(all_pos_clean)): 
	...
	name_key = '/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/train_yake/pos_anxia/key_pos_anxia' + str(i)
...
for i in range(len(all_neg_clean)): 
	...
	custom_kw_extractor = yake.KeywordExtractor(lan=language, n=max_ngram_size, dedupLim=deduplication_threshold, top=numOfKeywords, features=None)
	keywords1 = custom_kw_extractor.extract_keywords(text)
	name_key = '/home/est_posgrado_maria.garcia/Tesis/Proyecto_tecnologico/train_yake/neg_anxia/key_neg_anxia' + str(i)
	with open(name_key, 'wb') as f:
		pickle.dump(keywords1, f)
		f.close()
