...
for i in range(18):
    if i < 9:
        print('Experimen: ', i+37)
        f,a = run_exp_anxia_sim(i+37, all_pos, all_neg,test_anxia,test_labels_anxia,tr_label, num_feats[i],num_feats[i],tau=0.99,
                                          chose =1,fuzzy= True,remove_stop=False,train_data = True, compress=False)
        f_score.append(f)
        tol.append(0.99)
        ...
        print('experiment: ', i+37)
        f,a= run_exp_anxia_sim(i+37, all_pos, all_neg,test_anxia,test_labels_anxia, tr_label,num_feats[i-9],num_feats[i-9], tau=0.99,
                                          chose =1,fuzzy= True,remove_stop=True, train_data = True, compress = False)
        f_score.append(f)
        tol.append(0.99)
...
for i in range(18):
    if i < 9:
        print('Experiment: ', i+55)
        f,a = run_exp_anxia_sim(i+55, all_pos, all_neg,test_anxia,test_labels_anxia, tr_label,num_feats[i],num_feats[i],tau=0.99,
                                          chose =1,fuzzy = False, remove_stop=False,train_data = True, compress=False)
        f_score.append(f)
        tol.append(0.99)
        n_feat.append(num_feats[i])
        l5.append('False')
        ...
        print('Experiment: ', i+55)
        f,a= run_exp_anxia_sim(i+55, all_pos, all_neg,test_anxia,test_labels_anxia, tr_label,num_feats[i-9],num_feats[i-9], tau=0.99,
                                          chose =1,fuzzy= False,remove_stop=True, train_data = True, compress = False)
        f_score.append(f)
        tol.append(0.99)
        n_feat.append(num_feats[i-9])
        l5.append('True')
...
df.to_csv('/home/est_posgrado_maria.garcia/Proyecto_tecnologico/Results/Anorexia_sim/All_result_sim_anxia2.csv',sep='\t')
...
df.to_csv('/home/est_posgrado_maria.garcia/Proyecto_tecnologico/Results/Anorexia_sim/Best_Result_sim_anxia2.csv',sep='\t')
