...
for i in range(18):
    if i < 9:
        print('Experiment: ', i+181)
        f,a = run_exp_anxia_sim(i+181, all_pos, all_neg,test_anxia,test_labels_anxia,tr_label, num_feats[i],num_feats[i],tau=0.99,
        ...
        print('Experiment: ', i+181)
        f,a= run_exp_anxia_sim(i+181, all_pos, all_neg,test_anxia,test_labels_anxia,tr_label, num_feats[i-9],num_feats[i-9], tau=0.99,
...
for i in range(18):
    if i < 9:
        print('Experiment: ', i+199 )
        f,a = run_exp_anxia_sim(i+199, all_pos, all_neg,test_anxia,test_labels_anxia, tr_label,num_feats[i],num_feats[i],tau=0.99,
        ...
        print('Experiment: ', i+199)
        f,a= run_exp_anxia_sim(i+199, all_pos, all_neg,test_anxia,test_labels_anxia, tr_label,num_feats[i-9],num_feats[i-9], tau=0.99,
...
df.to_csv('/home/est_posgrado_maria.garcia/Proyecto_tecnologico/Results/Anorexia_sim/All_result_sim_anxia6.csv',sep='\t')
...
df.to_csv('/home/est_posgrado_maria.garcia/Proyecto_tecnologico/Results/Anorexia_sim/Best_Result_sim_anxia6.csv',sep='\t')
