...
for i in range(20):
    if i < 10:
        print('Experimento: ', i+161)
        f,a = run_exp_dep_sim(i+161, train_pos, train_neg,test,test_labels, train_y,num_feats[i], num_feats[i],tau=0.99,
        ...
        print('Experimento: ', i+161)
        f,a= run_exp_dep_sim(i+161, train_pos, train_neg,test,test_labels,train_y, num_feats[i-10],num_feats[i-10], tau=0.99,
...
for i in range(20):
    if i < 10:
        print('Experimento: ', i+181)
        f,a = run_exp_dep_sim(i+181, train_pos, train_neg,test,test_labels,train_y, num_feats[i],num_feats[i], tau=0.99,
        ...
        print('Experimento: ', i+181)
        f,a= run_exp_dep_sim(i+181, train_pos, train_neg,test,test_labels,train_y, num_feats[i-10],num_feats[i-10], tau=0.99,
...
df.to_csv('/home/est_posgrado_maria.garcia/Proyecto_tecnologico/Results/Depresion_sim/All_result_sim_dep5.csv', sep='\t')
...
df.to_csv('/home/est_posgrado_maria.garcia/Proyecto_tecnologico/Results/Depresion_sim/Best_Result_sim_dep5.csv', sep='\t')
