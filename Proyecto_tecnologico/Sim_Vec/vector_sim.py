...
def run_exp_anxia_sim(num_exp, pos_data, neg_data, test_data, test_labels, train_labels,num_feat1,num_feat2, 
    ...
    if train_data == False:
        ...
        result_name = 'result_anxia_sim' + str(num_exp) + '.txt'
        path_name =  '/home/est_posgrado_maria.garcia/Proyecto_tecnologico/Results/Anorexia_sim'+ '/' + result_name
        ...
        with open(path_name, "w") as f:
        	...
        	f.close()
        path_name_dic1 = '/home/est_posgrado_maria.garcia/Proyecto_tecnologico/Results/Anorexia_sim' + '/dictionary1_' + str(num_exp) + '.txt'
        path_name_dic2 = '/home/est_posgrado_maria.garcia/Proyecto_tecnologico/Results/Anorexia_sim' + '/dictionary2_' + str(num_exp) + '.txt'
...
def run_exp_dep_sim(num_exp, pos_data, neg_data, test_data, test_labels, train_labels,num_feat1,num_feat2, 
    ...
    if train_data == False:
        results,x , y,dic1,dic2 = classificator_pos_neg(pos_data, neg_data, test_data,num_feat1,num_feat2, 
        			tau=tau,chose=chose,fuzzy = fuzzy,remove_stop=remove_stop, train_data =train_data,compress = False)
        result_name = 'result_dep_sim' + str(num_exp) + '.txt'
        path_name =  '/home/est_posgrado_maria.garcia/Proyecto_tecnologico/Results/Depresion_sim'+ '/' + result_name
        ...
        with open(path_name, "w") as f:
        	...
        	f.close()
        path_name_dic1 = '/home/est_posgrado_maria.garcia/Proyecto_tecnologico/Results/Depresion_sim' + '/dictionary1_' + str(num_exp) + '.txt'
        path_name_dic2 = '/home/est_posgrado_maria.garcia/Proyecto_tecnologico/Results/Depresion_sim' + '/dictionary2_' + str(num_exp) + '.txt'
