...
for i in range(18):
    if i < 9:
        f = run_exp_anxia_sim(i+91, all_pos, all_neg,test_anxia,test_labels_anxia, tr_label,num_feats[i],num_feats[i],tau=0.99,
        ...
        f= run_exp_anxia_sim(i+91, all_pos, all_neg,test_anxia,test_labels_anxia, tr_label,num_feats[i-9],num_feats[i-9], tau=0.99,
...
df.to_csv('/home/est_posgrado_maria.garcia/Proyecto_tecnologico/Results/Anorexia_key/All_result_key_anxia3.csv',sep='\t')
...
df.to_csv('/home/est_posgrado_maria.garcia/Proyecto_tecnologico/Results/Anorexia_key/Best_Result_key_anxia3.csv',sep='\t')
