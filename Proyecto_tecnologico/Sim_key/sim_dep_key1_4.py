...
#for i in range(10):
#    print('Experimento: ', i+31)
#    f= run_exp_dep_sim(i+31, train_pos, train_neg,test,test_labels,train_y, num_feats[i],num_feats[i], tau=0.99,
...
df.to_csv('/home/est_posgrado_maria.garcia/Proyecto_tecnologico/Results/Depresion_key/All_result_key_dep1_4.csv', sep='\t')
