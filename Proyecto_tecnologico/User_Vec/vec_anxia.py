...
vocabulary = []
print('experiment 1')
f1,a1 = run_exp_anorexia(1,tr_anorexia,test_anxia,tr_label,test_labels_anxia,'dict29',option = 1,norm_data=True,norm_vec=False,
...
print('experiment 2')
f2,a2 = run_exp_anorexia(2,tr_anorexia,test_anxia,tr_label,test_labels_anxia,'dict29',option = 1,norm_data=True, norm_vec=False,
...
print('experiment 3')
f3,a3 = run_exp_anorexia(3,tr_anorexia,test_anxia,tr_label,test_labels_anxia,'dict29',option = 1,norm_data=True, norm_vec=True,
...
print('experiment 4')
f4,a4  = run_exp_anorexia(4,tr_anorexia,test_anxia,tr_label,test_labels_anxia,'dict29',option = 1,norm_data=True, norm_vec=True,
...
print('experiment 5')
f5,a5 = run_exp_anorexia(5,tr_anorexia,test_anxia,tr_label,test_labels_anxia, 'dict29',option = 1,norm_data=True, norm_vec=True,
...
print('experiment 6')
f6,a6 = run_exp_anorexia(6,tr_anorexia,test_anxia,tr_label,test_labels_anxia,'dict29',option = 1,norm_data=True, norm_vec=True,
...
print('experiment 7')
f7,a7 = run_exp_anorexia(7,tr_anorexia,test_anxia,tr_label,test_labels_anxia,'dict29_ex',option = 1,norm_data=True,norm_vec=False,
                         sub_param=norm_data1)
...
print('experiment 8')
f8,a8 = run_exp_anorexia(8,tr_anorexia,test_anxia,tr_label,test_labels_anxia,'dict29_ex',option = 1,norm_data=True, norm_vec=False,
                         sub_param=norm_data2)
f_score.append(f8)
best.append(a8)
norm_dataset.append(norm_data2['type'])
...
df.to_csv('/home/est_posgrado_maria.garcia/Proyecto_tecnologico/Results/Anorexia_vec/anorexia_vec_1.csv',
          sep='\t')
