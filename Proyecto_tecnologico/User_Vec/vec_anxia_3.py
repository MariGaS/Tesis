...
print('experiment 17')
f17,a17 = run_exp_anorexia(17,tr_anorexia,test_anxia,tr_label,test_labels_anxia,'dict51',option =1,norm_data=True, norm_vec=True,
...
print('experiment 18')
f18,a18 = run_exp_anorexia(18,tr_anorexia,test_anxia,tr_label,test_labels_anxia,'dict51',option =1,norm_data=True, norm_vec=True,
...
print('experiment 19')
f19,a19 = run_exp_anorexia(19,tr_anorexia,test_anxia,tr_label,test_labels_anxia,'dict51_ex',option =1,norm_data=True,norm_vec=False,
...
print('experiment 20')
f20,a20 = run_exp_anorexia(20,tr_anorexia,test_anxia,tr_label,test_labels_anxia,'dict51_ex',option =1,norm_data=True, norm_vec=False,
...
print('experiment 21')
f21,a21 = run_exp_anorexia(21,tr_anorexia,test_anxia,tr_label,test_labels_anxia,'dict51_ex',option =1,norm_data=True, norm_vec=True,
...
print('experiment 22')
f22,a22= run_exp_anorexia(22,tr_anorexia,test_anxia,tr_label,test_labels_anxia,'dict51_ex',option =1,norm_data=True, norm_vec=True,
...
print('experiment 23')
f23,a23 = run_exp_anorexia(23,tr_anorexia,test_anxia,tr_label,test_labels_anxia,'dict51_ex',option =1,norm_data=True, norm_vec=True,
                         sub_param=norm_data2,  param_norm= norm_vec1)
f_score.append(f23)
best.append(a23)
norm_dataset.append(norm_data2['type'])
...
print('experiment 24')
f24,a24 = run_exp_anorexia(24,tr_anorexia,test_anxia,tr_label,test_labels_anxia,'dict51_ex',option =1,norm_data=True, norm_vec=True,
                         sub_param=norm_data2,  param_norm= norm_vec2)
f_score.append(f24)
best.append(a24)
norm_dataset.append(norm_data1['type'])
...
df.to_csv('/home/est_posgrado_maria.garcia/Proyecto_tecnologico/Results/Anorexia_vec/result_anorexia_vec_3.csv',
          sep='\t')
