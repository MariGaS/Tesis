...
vocabulary = []
print('experiment 1')
f1,a1 = run_exp_anorexia(25,tr_anorexia,test_anxia,tr_label,test_labels_anxia,'dict29',option =3,norm_data=True,norm_vec=False,
                         sub_param=norm_data1)
f_score.append(f1)
best.append(a1)
norm_dataset.append(norm_data1['type'])
norm_vect.append('none')
vocabulary.append('dict29')

print('experiment 2')
f2,a2 = run_exp_anorexia(26,tr_anorexia,test_anxia,tr_label,test_labels_anxia,'dict29',option =3,norm_data=True, norm_vec=False,
...
print('experiment 3')
f3,a3 = run_exp_anorexia(27,tr_anorexia,test_anxia,tr_label,test_labels_anxia,'dict29',option =3,norm_data=True, norm_vec=True,
...
print('experiment 4')
f4,a4  = run_exp_anorexia(28,tr_anorexia,test_anxia,tr_label,test_labels_anxia,'dict29',option =3,norm_data=True, norm_vec=True,
...
print('experiment 5')
f5,a5 = run_exp_anorexia(29,tr_anorexia,test_anxia,tr_label,test_labels_anxia,'dict29',option =3,norm_data=True, norm_vec=True,
...
print('experiment 6')
f6,a6 = run_exp_anorexia(30,tr_anorexia,test_anxia,tr_label,test_labels_anxia,'dict29',option =3,norm_data=True, norm_vec=True,
...
print('experiment 7')
f7,a7 = run_exp_anorexia(31,tr_anorexia,test_anxia,tr_label,test_labels_anxia,'dict29_ex',option =3,norm_data=True,norm_vec=False,
                         sub_param=norm_data1)
...
print('experiment 8')
f8,a8 = run_exp_anorexia(32,tr_anorexia,test_anxia,tr_label,test_labels_anxia,'dict29_ex',option =3,norm_data=True, norm_vec=False,
                         sub_param=norm_data2)
f_score.append(f8)
best.append(a8)
norm_dataset.append(norm_data2['type'])
...
df.to_csv('/home/est_posgrado_maria.garcia/Proyecto_tecnologico/Results/Anorexia_vec/result_anorexia_vec_4.csv',
          sep='\t')
