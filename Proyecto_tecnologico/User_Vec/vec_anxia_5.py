...
print('experiment 9')
f9,a9 = run_exp_anorexia(33,tr_anorexia,test_anxia,tr_label,test_labels_anxia,'dict29_ex',option =3,norm_data=True, norm_vec=True,
...
print('experiment 10')
f10,a10 = run_exp_anorexia(34,tr_anorexia,test_anxia,tr_label,test_labels_anxia,'dict29_ex',option =3,norm_data=True, norm_vec=True,
...
print('experiment 11')
f11,a11 = run_exp_anorexia(35,tr_anorexia,test_anxia,tr_label,test_labels_anxia,'dict29_ex',option =3,norm_data=True, norm_vec=True,
...
print('experiment 12')
f12,a12 = run_exp_anorexia(36,tr_anorexia,test_anxia,tr_label,test_labels_anxia,'dict29_ex',option =3,norm_data=True, norm_vec=True,
...
print('experiment 13')
f13,a13 = run_exp_anorexia(37,tr_anorexia,test_anxia,tr_label,test_labels_anxia,'dict51',option =3,norm_data=True,norm_vec=False,
...
print('experiment 14')
f14,a14 = run_exp_anorexia(38,tr_anorexia,test_anxia,tr_label,test_labels_anxia,'dict51',option =3,norm_data=True, norm_vec=False,
...
print('experiment 15')
f15,a15 = run_exp_anorexia(39,tr_anorexia,test_anxia,tr_label,test_labels_anxia,'dict51',option =3,norm_data=True, norm_vec=True,
                         sub_param=norm_data1,  param_norm= norm_vec1)
f_score.append(f15)
best.append(a15)
norm_dataset.append(norm_data1['type'])
...
print('experiment 16')
f16,a16  = run_exp_anorexia(40,tr_anorexia,test_anxia,tr_label,test_labels_anxia,'dict51',option =3,norm_data=True, norm_vec=True,
                         sub_param=norm_data1,  param_norm= norm_vec2)
f_score.append(f16)
best.append(a16)
norm_dataset.append(norm_data1['type'])
...
df.to_csv('/home/est_posgrado_maria.garcia/Proyecto_tecnologico/Results/Anorexia_vec/result_anorexia_vec_5.csv',
          sep='\t')
