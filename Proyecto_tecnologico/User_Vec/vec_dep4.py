...
f1,a1 = run_exp_dep(25,train,test,labels_dep,test_labels,'dict29',option = 3,norm_data=True,norm_vec=False,
...
f2,a2 = run_exp_dep(26,train,test,labels_dep,test_labels,'dict29',option = 3,norm_data=True, norm_vec=False,
...
norm_vect.append('none')
vocabulary.append('dict29')
f3,a3 = run_exp_dep(27,train,test,labels_dep,test_labels,'dict29',option = 3,norm_data=True, norm_vec=True,
...
vocabulary.append('dict29')
f4,a4  = run_exp_dep(28,train,test,labels_dep,test_labels,'dict29',option = 3,norm_data=True, norm_vec=True,
...
vocabulary.append('dict29')
f5,a5 = run_exp_dep(29,train,test,labels_dep,test_labels,'dict29',option = 3,norm_data=True, norm_vec=True,
...
norm_vect.append(norm_vec1['type'])
vocabulary.append('dict29')
f6,a6 = run_exp_dep(30,train,test,labels_dep,test_labels,'dict29',option = 3, norm_data=True, norm_vec=True,
...
norm_vect.append(norm_vec2['type'])
vocabulary.append('dict29')
f7,a7 = run_exp_dep(31,train,test,labels_dep,test_labels,'dict29_ex',option = 3,norm_data=True,norm_vec=False,
                         sub_param=norm_data1)
f_score.append(f7)
best.append(a7)
norm_dataset.append(norm_data1['type'])
...
f8,a8 = run_exp_dep(32,train,test,labels_dep,test_labels,'dict29_ex',option = 3,norm_data=True, norm_vec=False,
                         sub_param=norm_data2)
f_score.append(f8)
best.append(a8)
norm_dataset.append(norm_data2['type'])
...
df.to_csv('/home/est_posgrado_maria.garcia/Proyecto_tecnologico/Results/Depresion_vec/result_dep_vec_4.csv',
          sep='\t')
