...
f9,a9 = run_exp_dep(33,train,test,labels_dep,test_labels,'dict29_ex',option = 3,norm_data=True, norm_vec=True,
...
f10,a10 = run_exp_dep(34,train,test,labels_dep,test_labels,'dict29_ex',option = 3,norm_data=True, norm_vec=True,
...
f11,a11 = run_exp_dep(35,train,test,labels_dep,test_labels,'dict29_ex',option = 3,norm_data=True, norm_vec=True,
...
norm_vect.append(norm_vec1['type'])
vocabulary.append('dict29_ex')
f12,a12 = run_exp_dep(36,train,test,labels_dep,test_labels,'dict29_ex',option = 3,norm_data=True, norm_vec=True,
...
norm_vect.append(norm_vec2['type'])
vocabulary.append('dict29_ex')
f13,a13 = run_exp_dep(37,train,test,labels_dep,test_labels,'dict51',option = 3,norm_data=True,norm_vec=False,
...
f14,a14 = run_exp_dep(38,train,test,labels_dep,test_labels,'dict51',option = 3,norm_data=True, norm_vec=False,
...
norm_vect.append('none')
vocabulary.append('dict51')
f15,a15 = run_exp_dep(39,train,test,labels_dep,test_labels,'dict51',option = 3,norm_data=True, norm_vec=True,
                         sub_param=norm_data1,  param_norm= norm_vec1)
f_score.append(f15)
best.append(a15)
norm_dataset.append(norm_data1['type'])
norm_vect.append(norm_vec1['type'])
vocabulary.append('dict51')
f16,a16  = run_exp_dep(40,train,test,labels_dep,test_labels,'dict51',option = 3,norm_data=True, norm_vec=True,
                         sub_param=norm_data1,  param_norm= norm_vec2)
f_score.append(f16)
best.append(a16)
norm_dataset.append(norm_data1['type'])
...
df.to_csv('/home/est_posgrado_maria.garcia/Proyecto_tecnologico/Results/Depresion_vec/result_dep_vec_5.csv',
          sep='\t')
