...
f17,a17 = run_exp_dep(41,train,test,labels_dep,test_labels,'dict51',option = 3,norm_data=True, norm_vec=True,
...
f18,a18 = run_exp_dep(42,train,test,labels_dep,test_labels,'dict51',option = 3,norm_data=True, norm_vec=True,
...
vocabulary.append('dict51')
f19,a19 = run_exp_dep(43,train,test,labels_dep,test_labels,'dict51_ex',option = 3,norm_data=True,norm_vec=False,
...
f20,a20 = run_exp_dep(44,train,test,labels_dep,test_labels,'dict51_ex',option = 3,norm_data=True, norm_vec=False,
...
norm_vect.append('none')
vocabulary.append('dict51_ex')
f21,a21 = run_exp_dep(45,train,test,labels_dep,test_labels,'dict51_ex',option = 3,norm_data=True, norm_vec=True,
...
norm_vect.append(norm_vec1['type'])
vocabulary.append('dict51_ex')
f22,a22= run_exp_dep(46,train,test,labels_dep,test_labels,'dict51_ex',option = 3,norm_data=True, norm_vec=True,
...
norm_vect.append(norm_vec2['type'])
vocabulary.append('dict51_ex')
f23,a23 = run_exp_dep(47,train,test,labels_dep,test_labels,'dict51_ex',option = 3,norm_data=True, norm_vec=True,
                         sub_param=norm_data2,  param_norm= norm_vec1)
f_score.append(f23)
best.append(a23)
norm_dataset.append(norm_data2['type'])
norm_vect.append(norm_vec1['type'])
vocabulary.append('dict51_ex')
f24,a24 = run_exp_dep(48,train,test,labels_dep,test_labels,'dict51_ex',option = 3,norm_data=True, norm_vec=True,
                         sub_param=norm_data2,  param_norm= norm_vec2)
f_score.append(f24)
best.append(a24)
norm_dataset.append(norm_data1['type'])
...
df.to_csv('/home/est_posgrado_maria.garcia/Proyecto_tecnologico/Results/Depresion_vec/result_dep_vec_6.csv',
          sep='\t')
